...
export default function AdminContestsPage() {
  ...
  const resetForm = () => {
    setForm({ title: '', description: '', durationMins: 60, maxPoints: 100, maxViolations: 3, startsAt: '', endsAt: '', reminderMinutes: 10, selectedProblems: [] })
    setEditingId(null)
    setShowForm(false)
      ...
      {showForm && (
        <div className="bg-[#111] border border-[#1e1e1e] rounded-xl p-4 flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-[10px] font-mono font-bold text-[#888] uppercase">Reminder (mins before)</label>
              <input type="number" min={1} max={60} className="bg-[#0a0a0a] border border-[#1e1e1e] rounded-lg px-3 py-2 text-xs text-[#f5f5f5] outline-none focus:border-emerald-500/50"
